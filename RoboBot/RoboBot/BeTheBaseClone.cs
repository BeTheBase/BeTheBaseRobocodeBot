...
namespace BCDK
{
    public class BeTheBaseClone : AdvancedRobot
    {
        ...
        public override void Run()
        {
            ...
            TurnRadarRight(360);
            dodgeBehaviour = new SequenceNode(blackBoard, new ScanNode(blackBoard, 360), new TrackNode(blackBoard, 360, 40), new AimNode(blackBoard), new MoveNode(blackBoard, 100));
            attackBehaviour = new SequenceNode(blackBoard,
                new ScanNode(blackBoard, 360),
                new TrackNode(blackBoard, 360, 30),
                new MoveToWardsNode(blackBoard, 80),
                new AimNode(blackBoard),
                new QSNode(blackBoard));
            currentBehaviour = dodgeBehaviour;
